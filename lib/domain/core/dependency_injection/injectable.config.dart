...
import '../../../infrastructure/search/search_repository.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i6.SearchService>(() => _i7.SearchRepository());
  gh.factory<_i8.DownloadsBloc>(
      () => _i8.DownloadsBloc(get<_i3.DownloadsService>()));
  gh.factory<_i9.SearchBloc>(() =>
      _i9.SearchBloc(get<_i3.DownloadsService>(), get<_i6.SearchService>()));
  return get;
}
